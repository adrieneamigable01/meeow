                ...
                try {
                    ...
                    if(count($data) == 1){
                        if($data[0]->gender == "Female"){
                            $logs = "Ms. {$data[0]->lastname} , {$data[0]->middlename} {$data[0]->firstname} - {$data[0]->district_name} Login to meeow for the date of {$date}";
                        }else{
                            $logs = "Mr. {$data[0]->lastname} , {$data[0]->middlename} {$data[0]->firstname} - {$data[0]->district_name} Login to meeow for the date of {$date}";
                        }
                        $payload_logs= array(
                            'logs'=> $logs,
                        );
                        ...
                        $response = array(
                            'isError'   => true,
                            'date'      => date("Y-m-d"),
                            'message'   => 'This email is not registered to our database'
                        );
                    }
